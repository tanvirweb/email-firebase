        ...
        <div>
            <form onSubmit={handleForm} className="max-w-md mx-auto p-4 rounded-md border my-10">
                ...
                <div className="space-y-3">
                    <input className="w-full py-2 px-4 rounded border" type="email" name="email" placeholder="Your email..." required />
                    <input className="w-full py-2 px-4 rounded border" type="password" name="password" placeholder="Password" required />
                    <input className="w-full py-2 px-4 rounded border bg-lime-900 text-white cursor-pointer" type="submit" value="Sign Up" />
                </div>
                {
                    signupSucces && <p className="text-center text-green-700 text-sm font-bold pt-3">{signupSucces}</p>
                }
                {
                    signupError && <p className="text-center text-red-700 text-sm font-bold pt-3">{signupError}</p>
                }
            </form>
        </div>
    );
